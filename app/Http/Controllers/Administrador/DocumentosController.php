...
class DocumentosController extends Controller
{
    public function show(){
        ...
        return view('administrador.documentos',$data);
    }

    public function list(){
        $documentos = Documentos::with(['empresa','usuario'])->where('status', '!=', 0)->get();
    ...
    public function crearCarpeta(Request $request){//Crear carpeta
        ...
        try {
            ...
            $service->permissions->create($folder->id, $permission, array('fields' => 'id'));
    ...
    public function compartirCarpeta(){
        ...
        // Crear el permiso
        $result=$service->permissions->create('1ZWcpktVaucP3Y0eyiXkQWwBeuLsZsVsO', $permission, array('fields' => 'id'));
    ...
    public function save(Request $request){
        ...
        $documento = Documentos::updateOrCreate(
    ...
    public function download($id){
        $basePath = base_path();
        $documento = Documentos::where('id', $id)->where('status', 1)->first();
        if (!$documento) {
