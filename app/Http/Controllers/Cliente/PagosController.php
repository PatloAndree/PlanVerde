...
class PagosController extends Controller
{
    public function show(){
        ...
        return view('cliente.pagos',$data);
    }

    public function list(){
        $empresa_id = auth()->user()->empresa_id;
        $pagos = Pagos::with(['plan','empresa','cliente','empresa.documento','cliente.documento'])->where('status','!=','0')->where('empresa_id',$empresa_id)->get();
