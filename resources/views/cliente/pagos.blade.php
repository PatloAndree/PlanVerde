            ...
            <form id="pagoForm"  novalidate>
              <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6 col-sm-12">
                        <div class="mb-3">
                            <label for="plan_tipo" class="form-label">Tipo</label>
                            <select class="form-select" id="plan_tipo" name="plan_tipo" required>
        ...
        const table = new DataTable('#tablePagos', {
            ...
            columns: [
                ...
                },
                {
                    data: null,
                    render: function(data, type, row) {
                        return `${row.plan.nombre.toUpperCase()}`;
                    }
                },
                { data: 'fecha_pago' },
                {
                    data: 'null',
                    render: function(data, type, row) {
                        return `${row.tipo_pago.toUpperCase()+'<br>   '+row.fecha_inicio + ' - '+ row.fecha_fin}`;
                    }
                },
                {
                    data: 'status',
