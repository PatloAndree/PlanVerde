...
@section('content')
    <div class="card shadow-sm">
        <div class="card-header border-bottom d-flex justify-content-between align-items-center">
            ...
            <button class="btn btn-primary" id="new-survey-btn" data-bs-toggle="modal" data-bs-target="#foroModal">+
                Nuevo Foro</button>
        </div>
    ...
    <script>
       const formGuardarForo = document.getElementById('foroForm');
        ...
        $('#foroModal').on('hidden.bs.modal', function() {
            document.getElementById('foroId').value = 0;
        ...
        function editar(id) {
            ...
            fetch(url)
                ...
                .then(result => {
                    ...
                    document.getElementById('foroId').value = data.id;
